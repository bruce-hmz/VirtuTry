...
export const blog = {
  author: { name: "VirtuTry Team", src: "/avatar.jpeg" },
  date: "2025-01-14",
  title: "Changelog for 2025",
  description:
    "Explore the latest updates and enhancements in our 2025 changelog. Discover new features and improvements that enhance user experience.",
  image:
