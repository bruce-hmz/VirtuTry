...
VirtuTry uses [Creem](https://creem.io) for payment processing, supporting both recurring subscriptions and one-time credit pack purchases.
...
3. **User completes payment** → Creem sends webhook to `/api/webhooks/creem`
